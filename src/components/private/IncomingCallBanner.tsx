...
export function IncomingCallBanner({ call, resolvedCallerName, onAccept, onDecline }: IncomingCallBannerProps) {
  ...
  return (
    <div
      className="fixed left-0 right-0 z-[90] px-3 pb-3 pt-3 animate-in slide-in-from-top fade-in duration-300"
      style={{ top: "env(safe-area-inset-top, 0px)" }}
    >
      <div className="max-w-sm mx-auto bg-card/95 backdrop-blur-md border border-border rounded-2xl shadow-2xl overflow-hidden">
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="w-10 h-10 rounded-full bg-green-600 flex items-center justify-center text-white hover:bg-green-700 transition-colors shadow-lg shadow-green-600/30"
